...
text = "[expr[term[term[factor[operand[var[c]]]]][+][factor[factor[operand[var[a]]]][*][operand[operand[(][expr[term[term[term[factor[operand[var[b]]]]][+][factor[operand[const[)]]]]][-][factor]]][)]]]]]]"
